...
const Navbar = () => {
  ...
  return (
    <div className="bg-slate-900 px-5 h-16 shadow-2xl flex flex-row justify-between w-full align-middle items-center">
      <div className="bg-slate-900 text-gray-300 sm:text-3xl max-sm:2xl">
